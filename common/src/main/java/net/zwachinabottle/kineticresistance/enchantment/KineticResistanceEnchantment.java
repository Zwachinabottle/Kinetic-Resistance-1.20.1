...
public class KineticResistanceEnchantment extends Enchantment {
    ...
    public KineticResistanceEnchantment() {
        super(Enchantment.Rarity.RARE, EnchantmentTarget.ARMOR, new EquipmentSlot[] {EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET, EquipmentSlot.HEAD});
        this.type = KineticResistanceEnchantment.Type.KINETIC;
    }
